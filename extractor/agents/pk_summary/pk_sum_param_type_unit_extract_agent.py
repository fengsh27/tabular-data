...
(5) The returned list should be like this:  
    {{"extracted_param_units": {{"parameter_types": ["Parameter type 1", "Parameter type 2", ...], "parameter_units": ["Unit 1", "Unit 2", ...]}}}}
...
class ParamTypeUnitExtractionResult(PKSumCommonAgentResult):
    ...
    extracted_param_units: ExtractedParamTypeUnits = Field(
        description="An object with lists of extracted parameter types and their corresponding units."
    )
