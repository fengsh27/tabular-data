...
from extractor.agents.pk_specimen_summary.pk_spec_sum_workflow_utils import (
    pk_spec_sum_enter_step,
    pk_spec_sum_leave_step,
)
...
class PKSpecSumCommonStep(ABC):
    ...
    def leave_step(
        ...
        res: PKSpecSumCommonAgentResult | None = None,
    ...
    def execute(self, state: PKSpecSumWorkflowState):
    ...
    def execute_directly(
        self,
        state: PKSpecSumWorkflowState,
    ) -> tuple[PKSpecSumCommonAgentResult, Any | None, dict | None]:
        """execute directly"""


class PKSpecSumCommonAgentStep(PKSpecSumCommonStep):
    def __init__(self):
        super().__init__()
    ...
    def get_instruction_prompt(self, state: PKSpecSumWorkflowState):
        """get instruction prompt"""
        return INSTRUCTION_PROMPT

    @abstractmethod
    def get_schema(self) -> PKSpecSumCommonAgentResult | dict:
        """get result schema (pydantic BaseModel or json schema)"""

    @abstractmethod
    def get_post_processor_and_kwargs(
        self, state: PKSpecSumWorkflowState
    ) -> tuple[
        Callable | None,
        dict | None,
    ]:
