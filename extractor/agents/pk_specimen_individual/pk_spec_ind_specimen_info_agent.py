...
Wrong answer: {res.specimen_combinations}, if the table does not explicitly mention any [Patient ID, Specimen, Sample N, Sample time], please leave it with [["N/A", "N/A", "N/A", "N/A"]].
""")
