...
`{{"times_and_units": [["0-1", "Hour", "... the sentence from the article ..."], ["10", "Minute", "... the sentence from the article ..."], ["0, 2, 4, 6", "Hour", "... the sentence from the article ..."], ["0-2, 2-4, 4-6, 6-8", "Hour", "... the sentence from the article ..."], ["N/A", "N/A", "... the sentence from the article ..."]]}}` (example)
