...
class PEStudyOutWorkflowState(TypedDict):
    """state data"""
...
def pe_study_out_enter_step(
    state: PEStudyOutWorkflowState, step_name: str, step_description: Optional[str] = None
):
