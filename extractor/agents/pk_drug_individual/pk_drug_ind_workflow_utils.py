...
class PKDrugIndWorkflowState(TypedDict):
    """state data"""
...
def pk_drug_ind_enter_step(
    state: PKDrugIndWorkflowState, step_name: str, step_description: Optional[str] = None
):
