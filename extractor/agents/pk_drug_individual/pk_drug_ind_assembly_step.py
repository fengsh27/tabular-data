...
from extractor.agents.pk_drug_individual.pk_drug_ind_common_agent import PKDrugIndCommonAgentResult
from extractor.agents.pk_drug_individual.pk_drug_ind_common_step import PKDrugIndCommonStep


class AssemblyStep(PKDrugIndCommonStep):
    """Assembly Step"""
    ...
    def execute_directly(self, state):
        ...
        df_patient_filtered = df_table_patient_refined[
            ["Patient ID", "Population", "Pregnancy stage", "Pediatric/Gestational age"]].copy()
