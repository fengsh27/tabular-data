...
from extractor.agents.pk_individual.pk_ind_assembly_step import AssemblyStep
from extractor.agents.pk_individual.pk_ind_drug_matching_step import (
    DrugMatchingAgentStep,
    DrugMatchingAutomaticStep,
)
from extractor.agents.pk_individual.pk_ind_header_categorize_step import (
    HeaderCategorizeStep,
)
from extractor.agents.pk_individual.pk_ind_summary_data_del_step import (
    SummaryDataDelStep,
)
from extractor.agents.pk_individual.pk_ind_param_type_align_step import (
    ParametertypeAlignStep,
)
from extractor.agents.pk_individual.pk_ind_param_type_unit_extract_step import (
    ExtractParamTypeAndUnitStep,
)
# Note: deprecated
# from extractor.agents.pk_individual.pk_ind_param_value_step import (
...
from extractor.agents.pk_individual.pk_ind_patient_info_step import (
    PatientInfoExtractionStep,
)
from extractor.agents.pk_individual.pk_ind_drug_info_step import DrugInfoExtractionStep

from extractor.agents.pk_individual.pk_ind_patient_matching_step import (
...
class PKIndWorkflow:
    ...
    def build(self):
        ...
        def select_patient_matching_step(state: PKIndWorkflowState):
        ...
        summary_data_del_step = SummaryDataDelStep()
        ...
        graph.add_node("summary_data_del_step", summary_data_del_step.execute)
        ...
        graph.add_node(
            "drug_matching_automatic_step", drug_matching_automatic_step.execute
        )
        graph.add_node("drug_matching_agent_step", drug_matching_agent_step.execute)

        graph.add_node(
            "patient_matching_automatic_step", patient_matching_automatic_step.execute
        )
        graph.add_node(
            "patient_matching_agent_step", patient_matching_agent_step.execute
        )
        ...
        graph.add_edge("summary_data_del_step", "param_type_align_step")
        ...
        graph.add_edge("patient_matching_automatic_step", "time_unit_step")
        graph.add_edge("patient_matching_agent_step", "time_unit_step")
