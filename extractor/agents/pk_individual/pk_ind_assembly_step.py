...
class AssemblyStep(PKIndCommonStep):
    """Assembly Step"""
    ...
    def execute_directly(self, state):
        ...
        for i in range(len(drug_list)):
            ...
            df_time_unit = markdown_to_dataframe(time_list[i])
            ...
            df_combined = pd.concat(
                ...
                [df_drug, df_table_patient, df_type_unit, df_time_unit], axis=1
            )
...
""",
        ...
        return (
            PKIndCommonAgentResult(reasoning_process=""),
            df_combined,
            {**DEFAULT_TOKEN_USAGE},
        )
