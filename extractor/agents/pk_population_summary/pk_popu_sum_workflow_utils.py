...
class PKPopuSumWorkflowState(TypedDict):
    """state data"""

    llm: BaseChatOpenAI
    full_text: str  # paper full text
    title: Optional[str]  # paper title
    md_table_characteristic: Optional[str]
...
def pk_popu_sum_enter_step(
    state: PKPopuSumWorkflowState, step_name: str, step_description: Optional[str] = None
):
