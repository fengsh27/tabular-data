...
It needs `beautifulsoup4` (see `curation-common/scripts/requirements.txt`).
...
14. **Verification + correction** — `prompts/14_verify_and_correct.md`
    Follows `curation-common/verify_and_correct.md` against the source:
