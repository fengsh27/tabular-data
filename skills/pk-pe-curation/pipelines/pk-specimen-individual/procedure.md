...
2. **Patient refine** — `prompts/02_patient_refine.md`
   ...
   Thin wrapper over `curation-common/refine_population.md` with
...
5. **Row cleanup** — `prompts/05_row_cleanup.md`
   Runs `curation-common/scripts/clean_specimen_rows.py` on
...
Stage 6 follows `curation-common/verify_and_correct.md`. Because the source
