...
from extractor.agents.pk_summary.pk_sum_drug_info_step import (
    DrugInfoExtractionStep
)
from extractor.agents.pk_summary.pk_sum_workflow_utils import PKSumWorkflowState

def test_DrugInfoExtractionStep_16143486_table_4(llm, md_table_16143486_table_4, caption_16143486_table_4, step_callback):
