...
@pytest.mark.skip()
def test_HeaderCategorizeStep_21474786_table_1(
    llm,
    step_callback,
    md_table_aligned_21474786_table_1,
    caption_21474786_table_1,
    md_table_drug_21474786_table_1,
):
    step = HeaderCategorizeStep()
    state = PKSumWorkflowState()
    state["llm"] = llm
    ...
    state["md_table_aligned"] = md_table_aligned_21474786_table_1
    state["caption"] = caption_21474786_table_1
    state["md_table_drug"] = md_table_drug_21474786_table_1
...
def test_HeaderCategorizeStep_19925470_table_3(
    llm,
    step_callback,
    md_table_aligned_19925470_table_3,
    ...
    state["md_table_aligned"] = md_table_aligned_19925470_table_3
    state["caption"] = caption_19925470_table_3
