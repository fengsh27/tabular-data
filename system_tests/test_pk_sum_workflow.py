...
@pytest.mark.skip()
def test_PKSumWorkflow_16143486_table_4(llm, html_content_16143486_table_4, caption_16143486_table_4, step_callback):
    workflow = PKSumWorkflow(llm=llm)
    workflow.build()
    df = workflow.go(html_content_16143486_table_4, caption_16143486_table_4, step_callback)
    print(df)
    logger.info("\n\n" + dataframe_to_markdown(df))
