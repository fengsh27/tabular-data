...
from benchmark.common_preprocess import common_preprocess
...
def preprocess_pk_drug_summary_table(csv_file: str) -> pd.DataFrame:
    return common_preprocess(csv_file)

def preprocess_pk_drug_individual_table(csv_file: str) -> pd.DataFrame:
    return common_preprocess(csv_file)

def preprocess_pk_population_individual_table(csv_file: str) -> pd.DataFrame:
    return common_preprocess(csv_file)

def preprocess_pk_population_summary_table(csv_file: str) -> pd.DataFrame:
    return common_preprocess(csv_file)

def preprocess_pk_specimen_individual_table(csv_file: str) -> pd.DataFrame:
    return common_preprocess(csv_file)

def preprocess_pk_specimen_summary_table(csv_file: str) -> pd.DataFrame:
    return common_preprocess(csv_file)
